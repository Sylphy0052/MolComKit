...
public class InformationMolecule extends Molecule{
	...
	public InformationMolecule(Position psn, int radius, int numSeq, MolComSim sim, NanoMachine src, int msgNum, MoleculeMovementType molMvType) { //ここ
	...
	public void move() {
		...
		NanoMachine rx = simulation.getMedium().getRxNanoMachineAtPos(getPosition(), getRadius()); //ここ
		if(rx != null)
		{
