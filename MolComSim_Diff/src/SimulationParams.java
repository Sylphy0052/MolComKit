...
public class SimulationParams {
	...
	private ArrayList<NanoMachineParam> transmitterParams = new ArrayList<NanoMachineParam>(); //ここ
	private ArrayList<NanoMachineParam> receiverParams = new ArrayList<NanoMachineParam>(); //ここ
	private ArrayList<IntermediateNodeParam> intermediateNodeParams = new ArrayList<IntermediateNodeParam>(); //ここ
